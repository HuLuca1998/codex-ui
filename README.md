...
到 [Releases](https://github.com/HuLuca1998/codex-ui/releases) 页面下载最新 `Codex-Viewer-<version>-arm64.zip`，
...
脚本会：① 跑 `build-mac.sh --zip` 产出 `Codex-Viewer-<ver>-arm64.zip`；
② 调 `gh release create vX.Y.Z` 上传 artifact + 自动生成 release notes。
